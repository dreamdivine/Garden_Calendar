...
plantData = {
    ...
    <p>Additionally, bean plants should be well - ventilated to promote proper development and deter mildew or mold that can trouble plants.</p> Beans should not be grown in the same spot more than once every four years, and can be mutually beneficial with corn, strawberries and cucumber.</p>
    ...
    "onion": `<h2>Growing Guide</h2> 
        ...
        <p>Well- drained, rich soil, high in organic matter, neutral pH.Optimum pH is 6.2 to 6.8.Requires plentiful, even moisture for good yields. Biennial grown as annual. Easy if you have rich well - drained soil and good weed control. Usually does not flower unless grown from sets that are too large(more than ½ to ¾ inches in diameter), or young plants(direct seeded or transplanted) are stressed by abnormally cold weather.</p>
         ...
         <h2> MAINTAINING </h2>
          ...
          <p> Can be direct - seeded, grown from transplants started inside, or from sets-- small bulbs about ½-inch in diameter grown from seed the previous season. Choose a weed - free, well - drained location.Raised beds are ideal.Onions are good for intercropping with other garden plants, especially early - maturing spring greens.Do not plant where other onion family crops have been grown in the past 3 years. Direct - seeding in the garden may not allow enough time for long - season varieties to mature, but is fine for shorter - season varieties or for scallions - onions harvested before the bulb forms. Direct - seed in spring when the soil reaches 50 F.Plant seed ¼ inch deep, ½ inch apart, in rows 12 to 18 inches apart.Thin to 4 - inch spacings for large bulbs, 2 - inch spacings for smaller bulbs but higher yields, or 1 - inch spacings for scallions. Start transplants inside about 8 to 10 weeks before last frost date.Plant 4 or 5 seeds in each cell, or seed in flats ¼ inch deep and ½ inch apart.If tops grow too tall and begin to droop, trim back to about 3 inches tall with scissors.After hardening off, transplant 2 to 4 weeks before last frost date.Space 4 inches apart for large bulbs, 2 inches apart for smaller bulbs, or 1 inch apart for scallions. From sets:   Choose bulbs no larger than ¾ inch in diameter.Large bulbs are more prone to bolting.Plant sets about 1 inch deep 2 to 4 weeks before last frost date.Space 4 inches apart for large bulbs or 2 inches apart for smaller bulbs. Onions have shallow root systems and need consistent moisture and good weed control.Water weekly if weather is dry, and mulch to retain moisture and suppress weeds.</p>
           <span class= "close"> X</span>`,
    ...
    "potato": `Growing Guide 
     ...
     <p>Requires at least 6 hours of sun each day. Prefers well- drained, light, deep, loose soil, high in organic matter.Unlike most vegetables, potatoes perform best in acid soil with pH 4.8 - 5.5. (Scab is less of a problem at low pH.If pH is more than 6.0, use scab - resistant varieties.) Needs plentiful, consistent moisture. Late spring frosts can damage foliage, but growth will usually rebound quickly from underground parts.</p>
       ...
       <h2> MAINTAINING </h2>
        ...
        <p> Potatoes perform best in areas where summers are cool(65 F to 70 F), but are widely adapted. Potatoes require well- drained soil. (They will rot under prolonged cold, wet conditions.) If your soil is poorly drained or a heavy clay, consider using raised beds.Adding organic matter(compost, cover crops, well - rotted manure or leaves) is a good way to improve soil before growing potatoes.Go easy on organic matter sources high in nitrogen(such as manure) and nitrogen fertilizer as too much nitrogen can encourage lush foliage at the expense of tuber production. Unlike most vegetables, potatoes perform best in acid soil with pH 4.8 - 5.5.Use scab - resistant varieties with pH above 6.0.Because most other garden vegetables perform best at near - neutral pH, it’s usually not feasible to grow potatoes in their preferred pH range, unless you dedicate one section of your garden to growing just potatoes in rotation with cover crops. Buy certified disease-free seed potatoes from garden centers or through online or mail-order catalogs for best results. If you save your own seed potatoes, discard any that show any signs of disease. Avoid planting potatoes from the supermarket because they may have been treated with sprout inhibitors. They may also be less vigorous and more prone to disease. If you must use supermarket potatoes, use round, white Maine-grown potatoes, not russets or long white potatoes grown in California or Idaho. To see if they'll sprout, take three potatoes and put them in a paper bag and place the bag in a warm location (about 70 F). They should sprout in two weeks if they haven't been treated with sprout inhibitors. Cut seed potatoes that are larger than a chicken egg into pieces about 1 inch across or slightly larger.Each piece should have at least one “eye” (the bud where the stem will grow from)-- preferably two eyes.Egg - sized and smaller tubers can be planted whole. Traditionally, cut seed potato pieces are allowed to cure for a few days to a few weeks before planting.This is because the cut potatoes need high humidity, plenty of oxygen and temperatures between 50 F and 65 F to heal quickly.If you have excellent, well - drained soil that meets those conditions, you can plant the seed pieces without curing.But if conditions are not right, the seed potatoes will rot in the ground.</p>
         <span class= "close">X</span>`,
    ...
    "squash": `<h2>Growing Guide </h2> 
     ...
     <p>Direct seed ½ to 1 inch deep into hills or rows. Sow 4 to 5 seeds per hill. Space hills about 4 to 8 feet apart, depending on the size of the fruit. (The larger the expected size of the squash, the larger the vine and the farther apart you should space the hills.)   When the plants are 2 to 3 inches tall, thin to 2 to 3 plants per hill by snipping off unwanted plants without disturbing the roots of the remaining ones. In rows, sow seeds 6 to 12 inches apart in rows 4 to 8 feet apart. Snip off plants to thin to one plant every 18 to 36 inches. </p>
       ...
       <p>Direct seed ½ to 1 inch deep into hills or rows. Sow 4 to 5 seeds per hill. When the plants are 2 to 3 inches tall, thin to 2 to 3 plants per hill by snipping off unwanted plants without disturbing the roots of the remaining ones. In rows, sow seeds 4 inches apart in rows 4 to 5 feet apart. Snip off plants to thin to one plant every 12 to 24 inches.</p>
        <span class= "close">X</span>`,
    "watermelon": `As they require a long growing season, watermelons are best started indoors approximately 3-4 weeks prior to the last frost of the season. Sow seeds 1/4 inch deep in flats or small pots, sowing 3 seeds per pot.Keep medium moist while awaiting germination.Additionally, watermelon seeds will show better germination rates with heat.Keep the soil between 80-90 degrees, using a heat mat if necessary.Seed should begin to germinate within 3-10 days. Once seeds start to germinate, lower soil temp slightly to the mid 70s, for 1 - 2 weeks, also decreasing water.Thin to one plant per cell or pot.Once the first set of true leaves has developed, reduce waterings once more, but do not allow plant to become desiccated. Harden plant by gradually exposing to outdoor conditions.Transplant to permanent site in late spring after the last frost has passed.If possible, transplant on an overcast day to minimize wilting and create a more amenable environment for your young plant. </p>
